...
BpodSystem.GUIHandles.OutcomePlot.HandleTrialRate = axes('Position',   [1*.05 + 0*.08   .65  .1  .3],'Visible','off');
BpodSystem.GUIHandles.OutcomePlot.HandleStimDelay = axes('Position',   [2*.05 + 1*.08   .65  .1  .3],'Visible','off'); % old HandleFix
BpodSystem.GUIHandles.OutcomePlot.HandleSampleTime = axes('Position',  [3*.05 + 2*.08   .65  .1  .3],'Visible','off');
BpodSystem.GUIHandles.OutcomePlot.HandleMoveTime = axes('Position',    [4*.05 + 3*.08   .65  .1  .3],'Visible','off');

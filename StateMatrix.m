...
%% Set up state matrix    
sma = NewStateMatrix();
sma = SetGlobalTimer(sma,1,TaskParameters.GUI.SampleTime); % used to track centre poke grace period
sma = SetGlobalTimer(sma,2,DelayTime); % used to track side poke grace period

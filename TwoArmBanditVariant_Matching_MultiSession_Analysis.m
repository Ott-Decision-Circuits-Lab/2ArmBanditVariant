...
for iSession = 1:length(DataHolder)
    ...
    NoTrialStartYData(iSession, 1:length(NoTrialStartLine{iSession}.YData)) = NoTrialStartLine{iSession}.YData;
    ...
    Block1TransitionLine{iSession} = line(Block1TransitionAxes,...
                                          'xdata', -10:50,...
                                          'ydata', smooth(movmean(ChosenPHigh, [10 9])) * 100,...
                                          'LineStyle', '-',...
                                          'Marker', 'none',...
                                          'Color', SessionColor);
    
    Block1TransitionYData(iSession, :) = Block1TransitionLine{iSession}.YData;
    ...
    Block2TransitionYData(iSession, :) = Block2TransitionLine{iSession}.YData;
    ...
    if ~isempty(BlockTransitionIdx)
        ...
        Block3TransitionYData(iSession, :) = Block3TransitionLine{iSession}.YData;
    ...
    if ~isempty(BlockTransitionIdx)
        ...
        Block4TransitionYData(iSession, :) = Block4TransitionLine{iSession}.YData;
...
LeftBlock1TransitionLine{iSession + 2} = line(Block1TransitionAxes,...
                                              'xdata', -10:50,...
                                              'ydata', AverageLeftBlock1Transition,...
                                              'LineStyle', '-',...
                                              'Marker', 'none',...
                                              'Color', sand);
...
RightBlock1TransitionLine{iSession + 3} = line(Block1TransitionAxes,...
                                               'xdata', -10:50,...
                                               'ydata', AverageRightBlock1Transition,...
                                               'LineStyle', '-',...
                                               'Marker', 'none',...
                                               'Color', turquoise);
...
Block2TransitionLine{iSession + 2} = line(Block2TransitionAxes,...
                                          'xdata', -10:50,...
                                          'ydata', AverageLeftBlock2Transition,...
                                          'LineStyle', '-',...
                                          'Marker', 'none',...
                                          'Color', sand);
...
Block2TransitionLine{iSession + 3} = line(Block2TransitionAxes,...
                                          'xdata', -10:50,...
                                          'ydata', AverageRightBlock2Transition,...
                                          'LineStyle', '-',...
                                          'Marker', 'none',...
                                          'Color', turquoise);
...
Block3TransitionLine{iSession + 2} = line(Block3TransitionAxes,...
                                          'xdata', -10:50,...
                                          'ydata', AverageLeftBlock3Transition,...
                                          'LineStyle', '-',...
                                          'Marker', 'none',...
                                          'Color', sand);
...
Block3TransitionLine{iSession + 3} = line(Block3TransitionAxes,...
                                          'xdata', -10:50,...
                                          'ydata', AverageRightBlock3Transition,...
                                          'LineStyle', '-',...
                                          'Marker', 'none',...
                                          'Color', turquoise);
...
Block4TransitionLine{iSession + 2} = line(Block4TransitionAxes,...
                                          'xdata', -10:50,...
                                          'ydata', AverageLeftBlock4Transition,...
                                          'LineStyle', '-',...
                                          'Marker', 'none',...
                                          'Color', sand);
...
Block4TransitionLine{iSession + 3} = line(Block4TransitionAxes,...
                                          'xdata', -10:50,...
                                          'ydata', AverageRightBlock4Transition,...
                                          'LineStyle', '-',...
                                          'Marker', 'none',...
                                          'Color', turquoise);

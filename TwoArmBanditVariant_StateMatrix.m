...
COutStateChange = 'BrokeFixation';
if TaskParameters.GUI.RestartInvalidTrial
    COutStateChange = 'InvalidTrial';
end
sma = AddState(sma, 'Name', 'StimulusDelay',...
    'Timer', TaskParameters.GUI.StimDelay,...
    'StateChangeConditions', {'Tup', 'Sampling',...
                              CenterPortOut, COutStateChange,...
                              'GlobalTimer1_End', 'StillSampling'},...
    'OutputActions', {});

sma = AddState(sma, 'Name', 'InvalidTrial',... % dummy state for counting how many invalid trial
    'Timer', 0,...
    'StateChangeConditions', {'Tup', 'WaitCIn'},...
    'OutputActions', {});
...
SamplingGraceStateChange = 'EarlyWithdrawal';
if TaskParameters.GUI.RestartInvalidTrial
    SamplingGraceStateChange = 'InvalidTrial';
end
sma = AddState(sma, 'Name', 'SamplingGrace',...
    'Timer', TaskParameters.GUI.SamplingGrace,...
    'StateChangeConditions', {CenterPortIn, 'Sampling',...
                              'Tup', SamplingGraceStateChange,...
                              'GlobalTimer1_End', SamplingGraceStateChange,...
                              LeftPortIn, SamplingGraceStateChange,...
                              RightPortIn, SamplingGraceStateChange},...
    'OutputActions', {});
